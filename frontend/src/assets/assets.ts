...
export const heroSectionData = {
    description: "We shop the same stalls your family's shopped for years — so you don't have to fight the Friday crowd for it.",
    hero_image: hero_bg,
    hero_features: [
        { icon: TruckIcon, title: "Free Delivery", desc: "Orders over 2000 tk" },
...
export const footerData = {
    ...
    contact: [
        { icon: MapPinIcon, text: "1236 Green Rd, Dhaka" },
        { icon: PhoneIcon, text: "+1 (111) 123-4567" },
        { icon: MailIcon, text: "hello@example.com" },
    ],

    bottom: {
        copyright: "© 2026 DailyDrop. All rights reserved.",
        links: [
